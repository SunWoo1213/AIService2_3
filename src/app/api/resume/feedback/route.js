...
1. **직무 적합성**: 채용 공고의 키워드, 필수 역량, 우대사항이 얼마나 잘 반영되어 있는가?
2. **구체성 및 정량화**: 추상적 표현 대신 구체적 수치, 성과, 기간이 명시되어 있는가?
3. **문법 및 표현**: 맞춤법, 띄어쓰기, 문장 구조가 올바른가? 전문적인 표현을 사용하는가?
4. **논리성 및 구조**: 내용의 흐름이 자연스럽고 논리적인가? STAR 기법이 적용되었는가?
5. **차별화 및 임팩트**: 다른 지원자와 구별되는 독특한 경험이나 강점이 있는가?
